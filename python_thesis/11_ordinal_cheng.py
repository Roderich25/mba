        ...
        for af in ['relu']:  # ['sigmoid', 'relu', 'tanh']:
            for l2 in [0.001]:  # [0, 0.0001, 0.001, 0.01, 0.1]:
                for nn in [1]:  # [1, 2, 3]:
                    ...
                    ax1.set_xticks([])
                    ax1.set_yticks([])
                    txt = "Categorías de 2015, de acuerdo a Vargas-Chanes y Váldez-Cruz (2019)."
                    #ax1.text(15, 0.01, txt, wrap=True, horizontalalignment='center', fontsize=12, **csfont)
                    ...
                    y_pred = np.sum(np.round(model.predict(X)), axis=1)
                    ...
                    #txt = "Categorías de rezago social predichas por modelo ANN-ORD para 2015."
                    #ax2.text(15, 0.01, txt, wrap=True, horizontalalignment='center', fontsize=12, **csfont)
